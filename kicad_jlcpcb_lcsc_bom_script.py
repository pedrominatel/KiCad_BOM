...
out.writerow(['Designator', 'Quantity', 'Value', 'LCSC Part #', 'MPN', 'Footprint', 'Description'])
...
for group in grouped:
    ...
    out.writerow([refs, len(group), c.getValue(), c.getField("LCSC"), c.getField("MPN"), c.getFootprint(),
        c.getDescription()])
